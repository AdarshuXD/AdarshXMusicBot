...
from AdarshXMusic.utils.database import get_authuser_names, get_cmode
from AdarshXMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AdarshXMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await AdarshX.stop_stream(message.chat.id)
    except:
        pass
